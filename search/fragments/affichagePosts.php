                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mr-2">
                                        ...
                                        $client=$repoclient->findByUsername($post->username);
                                        $worker=$repoworker->findByUsername($post->username);
                                        if($client){
                                        ...
                                        if($pic){
                                            ?>
                                            <img id="profile-img" src="../assets/images/<?= $pic ?>"  style="width:60px" alt="" />
                                        <?php } else {?>
                                            <img id="profile-img" src="../assets/images/default.jpg" style="width:60px" alt="" />
                                        <?php } ?>
                                    </div>
                                    <div class="ml-2">
                                        <div class="h5 m-0">
                                            <a href="../fragments/Profile.php?username=<?= $post->username ?> ">  <?= "@" . $post->username ?></a>
                                        </div>
