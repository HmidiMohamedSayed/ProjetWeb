    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-12">
            ...
            <div class="card p-4 mt-3">
                <a href="messaging.php" class="btn btn-xs btn-primary mb-2" style="float: right">Messaging System</a>
                <a href="Logout.php" class="btn btn-xs btn-primary mb-2" style="float: right">Logout</a>
