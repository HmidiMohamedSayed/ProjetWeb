        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
             ...
             <?php if(!isset($_SESSION['username'])){ ?> <li class="scroll-to-section"><div class="main-red-button"><a href="Login.php">Log in</a></div></li>
              <?php  } else { ?>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.25s">
          <form id="contact" action="ajoutWorker.php" method="post">
              <?php
              session_start();
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <fieldset>
                  <input type="text" name="phone" id="email"  placeholder="Phone number" required="">
                </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
