            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                       ...
                       <li class="scroll-to-section"><button  style="border-style: hidden;background-color: transparent;width : 40px; padding-bottom: 5px;margin-top: 22px;margin-bottom: 30px" data-toggle="modal" data-target="#myModal"><i class="fa fa-bell" aria-hidden="true" style="width:30px"></i></button></li>
                        </div>
                    </ul>
